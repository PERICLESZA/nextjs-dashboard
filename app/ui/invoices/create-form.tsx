        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              value={formValues.customerId} // Vincula o valor ao estado
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input 
              ...
              value={formValues.amount} // Vincula o valor ao estado
              onChange={handleInputChange} // Atualiza o estado quando o valor muda
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  checked={formValues.status === 'pending'} // Vincula ao estado
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  checked={formValues.status === 'paid'} // Vincula ao estado
                  onChange={handleInputChange} // Atualiza o estado
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                  aria-describedby="status-error"
                />
